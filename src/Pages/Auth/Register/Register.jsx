//when user register save user to database with default role as customer
...
const Register = () => {
    ...
    const saveUserToDB = async (user, name, photoURL) => {
        try {
            const userData = {
                name: name || user.displayName || 'User',
                email: user.email,
                photoURL: photoURL || user.photoURL || '/default-avatar.png',
                role: 'customer',
                createdAt: new Date(),
            ...
            console.log('User saved to database with customer role');
        } catch (error) {
