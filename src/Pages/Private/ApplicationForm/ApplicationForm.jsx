...
const ApplicationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const requiredFields = {
        ...
        'email': 'Email Address', 
        'phone': 'Phone Number',
        'nidNumber': 'NID/Passport Number',
        'nomineeName': 'Nominee Name',
        'nomineeRelationship': 'Nominee Relationship',
        'annualIncome': 'Annual Income'
    };
    
    const missingFields = Object.keys(requiredFields).filter(field => !applicationData[field] || applicationData[field].toString().trim() === '');
    
    if (missingFields.length > 0) {
        const missingFieldNames = missingFields.map(field => requiredFields[field]);
        Swal.fire({
            title: 'Missing Information',
            html: `Please fill in all required fields:<br><strong>${missingFieldNames.join(', ')}</strong>`,
            icon: 'warning',
            confirmButtonText: 'OK'
        });
        return;
    ...
    if (applicationData.annualIncome && parseFloat(applicationData.annualIncome) <= 0) {
        Swal.fire({
        ...
        <Card className="w-full max-w-md mx-4 border-border">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Please start from the quote page to begin your application.
            </p>
            <Button
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Button
            ...
            onClick={() =>
              navigate(`/quotes/${id}`, {
                state: { quoteData, estimatedPremium, policy },
              })
            }
            ...
            <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange("nomineeRelationship", value)
                        }
                      >
                        <SelectTrigger>
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Please disclose any health conditions for accurate
                    underwriting
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {healthConditionsList.map((condition) => (
                        ...
                        >
                          ...
                          <Checkbox
                            id={condition}
                            checked={applicationData.healthConditions.includes(
                              condition
                            )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      {" "}
                      {/* Increased space-y-3 to space-y-4 */}
