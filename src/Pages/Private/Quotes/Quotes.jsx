...
const Quotes = () => {
    ...
    const calculatePremium = () => {
        ...
        setTimeout(() => {
            ...
            // Gender factor (slightly higher for males)
            if (quoteData.gender === 'male') {
                annualPremium *= 1.1;
            }
            
            // Smoker factor (significantly higher for smokers)
            if (quoteData.isSmoker === 'yes') {
                annualPremium *= 1.5;
            }
            
            // Duration discount (longer terms get slight discount)
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="border-border/50 bg-card/50 backdrop-blur-sm shadow-2xl">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Fill in your details to get an accurate premium estimate for {policy?.title}
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                {/* Coverage Amount */}
                                <div className="space-y-3">
                                    <Label htmlFor="coverageAmount" className="text-sm font-semibold">
                                        Coverage Amount *
                                    </Label>
                                    <Select 
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Available range: {formatCurrency(policy?.coverage?.minAmount)} - {formatCurrency(policy?.coverage?.maxAmount)}
                                    </p>
                                </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <h4 className="font-semibold text-foreground">How is the premium calculated?</h4>
                                        <p className="text-sm text-muted-foreground">
                                            Premiums are based on your age, gender, coverage amount, policy duration, and smoking status. 
                                            Younger, non-smoking individuals typically get lower rates.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-semibold text-foreground">Is this quote guaranteed?</h4>
                                        <p className="text-sm text-muted-foreground">
                                            This is an estimate. Your final premium may vary based on medical underwriting and additional risk factors.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-semibold text-foreground">What payment options are available?</h4>
                                        <p className="text-sm text-muted-foreground">
                                            You can pay monthly, quarterly, or annually. Annual payments often come with a discount.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-semibold text-foreground">Can I change my coverage later?</h4>
                                        <p className="text-sm text-muted-foreground">
                                            Yes, most policies allow you to increase or decrease coverage during annual reviews, subject to underwriting.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
                                ...
                                {estimatedPremium ? (
                                    <>
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-semibold">{formatCurrency(quoteData.coverageAmount)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-muted-foreground">Policy Term</span>
                                                <span className="font-semibold">{quoteData.duration} years</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-muted-foreground">Total Premium</span>
                                                <span className="font-semibold">${estimatedPremium.total}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-muted-foreground">Your Age</span>
                                                <span className="font-semibold">{quoteData.age} years</span>
                                            </div>
                                        </div>
                                        ...
                                        <Alert className="bg-green-500/10 border-green-500/20">
                                            ...
                                            <AlertDescription className="text-green-600 dark:text-green-400">
                                                Great news! You qualify for this policy based on your information.
                                            </AlertDescription>
                                        </Alert>
                                    </>
                                ) : (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-muted-foreground">
                                            Fill in your details to see your personalized premium estimate
                                        </p>
                                    </div>
                                )}
                            </CardContent>
                        ...
                        <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold text-foreground">{policy?.category}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-muted-foreground">Base Rate</span>
                                    <span className="font-semibold text-foreground">{policy?.premiumDetails?.baseRate}%</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-muted-foreground">Age Range</span>
                                    <span className="font-semibold text-foreground">{policy?.minAge} - {policy?.maxAge} years</span>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
