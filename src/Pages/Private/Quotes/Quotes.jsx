...
//                                 {/* Coverage Amount */}
//                                 <div className="space-y-4">
//                                     <Label htmlFor="coverageAmount" className="text-base font-semibold">
//                                         Coverage Amount *
//                                     </Label>
//                                     <Select 
...
//                                 {/* Smoker Status */}
//                                 <div className="space-y-4">
//                                     <Label className="text-base font-semibold">Do you smoke?</Label>
//                                     <RadioGroup 
...
//                                             <Label htmlFor="non-smoker" className="cursor-pointer text-base">Non-smoker</Label>
//                                         </div>
//                                         <div className="flex items-center space-x-3">
//                                             <RadioGroupItem value="yes" id="smoker" />
//                                             <Label htmlFor="smoker" className="cursor-pointer text-base">Smoker</Label>
//                                         </div>
//                                     </RadioGroup>
//                                 </div>
...
//                     {/* Results Sidebar - Removed sticky positioning */}
//                     <div className="space-y-6">
//                         {/* Premium Results */}
//                         <Card className="border-border/50 bg-card/50 backdrop-blur-sm shadow-2xl">
...
const Quotes = () => {
    ...
    const calculatePremium = () => {
        ...
        // Validate age before calculating
    ...
    const handleAgeBlur = (e) => {
        ...
        // Recalculate premium if age is valid
    ...
    const isFormValid = estimatedPremium && !ageError && quoteData.age && quoteData.coverageAmount && quoteData.duration;
                            ...
                            <CardContent className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Input
                                        ...
                                        placeholder={`Enter age (${policy?.minAge}-${policy?.maxAge} years)`}
                                        className={`w-full mt-2 ${ageError ? 'border-destructive' : ''}`}
                                    />
                                    {ageError && (
